...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx6205f2625d46dc75',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '56b6bcb4e2384ed43e185b88a33f1d21',
  ...
  USERS: [
    {
      ...
      id: 'o3S0U505sHB1ix1jT_Vuo9Sp5ds0',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'F_en52I9D-Tq5lGjsE9K0wmk7wl3926V2IKFq8ZVXfA',
      // 所在省份
      province: '广东',
      // 所在城市
      city: '深圳',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '1993', date: '11-05',
        },
        
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
      
        {
          type: '节日', name: '结婚纪念日', year: '2020', date: '03-25',
        }
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2018-01-10' },
        // 结婚纪念日
        { keyword: 'marry_day', date: '2020-08-07' 
      ],
      // 课程表相关配置
